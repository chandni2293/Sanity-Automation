...
public class ReceiptReportPage extends BaseLibrary {
	public static Logger logger = LogManager.getLogger(ReceiptReportPage.class);
...
//					.concat(AfmNewOrderConstants.RECEIPT_END_PATH));
	...
	/**
	 * Reports-->Receipt-->Receipt Discount
	 */
	public void receiptDiscount() {

		logger.info("Receipt Discount");
		CommonActions.clickOnElement(AfmNewOrderConstants.REPORTS_XPATH);
		CommonActions.clickOnElement(AfmNewOrderConstants.RECEIPT_XPATH);
		CommonActions.clickOnElement(AfmNewOrderConstants.RECEIPT_DISCOUNT_XPATH);
		CommonActions.clickOnElement(AfmNewOrderConstants.RECEIPT_ADVANCE_SEARCH_XPATH);
		CommonActions.selectByVisibleText(AfmNewOrderConstants.RECEIPT_CURRENCY_XPATH,
				AfmNewOrderConstants.CURRENCY_VALUE_CAD);
		CommonActions.clickOnElement(AfmNewOrderConstants.SEARCH_DISCOUNT_XPATH);
		CommonActions.clickAndEnterText(AfmNewOrderConstants.SEARCH_TRIP_XPATH, receiptDiscountTypeName);
		WaitUtility.pause(AfmCommonConstants.THREE);
		driver.findElement(By.xpath(AfmNewOrderConstants.SEARCH_TRIP_XPATH)).sendKeys(Keys.ENTER);
		WaitUtility.pause(AfmCommonConstants.ONE);
		CommonActions.clickOnElement(AfmNewOrderConstants.SUBMIT_XPATH);
	}

	/**
	 * Verify Receipt Discount Report
	 */
	public boolean verifyReceiptDiscountReport() {

		logger.info("Verify Receipt Discount Report");
		return CommonActions.verifyElementDisplayed(AfmNewOrderConstants.VERIFY_RECEIPT_DISCOUNT_REPORT);
	}

	/**
	 * Reports-->Receipt-->Receipt Discount Print
	 */
	public void receiptDiscountPrint() {

		logger.info("Receipt Discount Print SuccessFully");
		CommonActions.clickOnElement(AfmNewOrderConstants.RECEIPT_PRINT_XPATH);
		WaitUtility.pause(AfmCommonConstants.ONE);
		CommonActions.clickOnElement(AfmNewOrderConstants.REFERSH_REPORT_XPATH);
	}

	/**
	 * Reports-->Receipt-->Receipt Discount Email
	 */
	public void receiptDiscountEmail() {

		logger.info("Receipt Discount Email");
		CommonActions.clickOnElement(AfmNewOrderConstants.EMAIL_XPATH);
